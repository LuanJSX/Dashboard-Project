import { ArrowUpRight, ShoppingCart, DollarSign, Users, Eye, ArrowDown, ArrowDownRight } from "lucide-react";
...
const stats = [
    {
        ...
        bgColor: "bg-emerald-50 dark:bg-emerald-900/28",
      ...
      },
      {
        ...
        bgColor: "bg-blue-50 dark:bg-blue-900/28",
      ...
      },
      {
        ...
        bgColor: "bg-purple-50 dark:bg-purple-900/28",
        textColor: "text-emerald-600 dark:text-purple-400",
      },
      {
        ...
        bgColor: "bg-orange-50 dark:bg-orange-900/28",
        ...
        return (
          ...
          >
            ...
            <div className="mt-4 h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
              <div
                className={`w-full ${stats.color} bg-gradient-to-r rounded-full transition-all duration-100`} style={{width: stats.trend === "up" ? "75%" : "45%"}}
              ></div>
            </div>
          </div>
        );
